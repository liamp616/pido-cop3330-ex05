...
You’ll often write programs that deal with numbers. And depending on the programming language you use, you’ll have to convert the inputs
you get to numerical data types.
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        myApp.math(firstNum, secNum);
    }

    public void math(int firstNum, int secNum) {
